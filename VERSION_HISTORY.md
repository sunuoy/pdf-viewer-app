...
- **MAJOR / Structural Changes (`1.0.1` bump)**: Used for major architectural shifts, breaking layout overhauls, database redesigns, or bumping the minimum SDK version (e.g., `1.0.2` -> `2.0.3`).
